...
# Net2Net_Cifar10_Reference_deeper_scratch.py v0.9 01.05.2017
#
...
#
# Net2Net_Cifar10_Reference_deeper_scratch.py contains the reference network used to test Net2DeeperNet.
# It is built on following model:
...
CHKPT = './reference-deeper-model' # File containing the teacher model
PATH_TENSORBOARD_LOG = './cifar-10-python/cifar-10-logs/reference-deeper-scratch'
