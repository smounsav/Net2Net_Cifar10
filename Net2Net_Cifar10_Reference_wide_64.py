...
# Net2Net_Cifar10_Reference_wide_64.py v0.9 01.05.2017
#
...
#
# Net2Net_Cifar10_Reference_wide_64.py contains the teacher CNN that we will use
# in the different experiments of the project
# The teacher CNN is built on following model:
#   - an input layer taking as input images of size 32x32x3 height * width * colors  
#   - a convolutional layer with patch 5x5, stride (1,1), 3 input channels, 64 output channels
#   - a relu activation layer
#   - a max_pool pooling layer with patch 2x2
#   - a normalisation layer
#   - a convolutional layer with patch 5x5, stride (1,1), 64 input channels, 64 output channels
#   - a relu activation layer
#   - a max_pool pooling layer with patch 2x2
#   - a normalisation layer
#   - a fully connected layer with 1024 nodes
#   - an output fully connected layer with 10 nodes, with a dropout probability of 0.5
# ==================================================================
...
PATH_TENSORBOARD_LOG = './cifar-10-python/cifar-10-logs/reference-wide-64'
...
with tf.name_scope("ConvLayer1"):
    W_conv1 = N2NMoTb.init_weight([5, 5, 3, 64]) # 5x5 patch, 3 input channels, 64 output channels
    b_conv1 = N2NMoTb.init_bias([64])
...
with tf.name_scope("ConvLayer2"):
    W_conv2 = N2NMoTb.init_weight([5, 5, 64, 64]) # 5x5 patch, 64 input channels, 64 output channels
