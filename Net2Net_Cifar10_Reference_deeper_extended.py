...
# Net2Net_Cifar10_Reference_deeper_extended.py v0.9 01.05.2017
#
...
#
# Net2Net_Cifar10_Reference_deeper_extended.py contains an extension of the first CNN layer of the teacher CNN.
...
#   - an output fully connected layer with 10 nodes, with a dropout of probability 0.5
# ==================================================================
...
PATH_TENSORBOARD_LOG = './cifar-10-python/cifar-10-logs/reference-deeper-extended'
...
VARIABLES_TO_RESTORE = {'W_conv1': W_conv1, 'b_conv1': b_conv1, 'W_conv2': W_conv2, 'b_conv2': b_conv2, 'W_fc1': W_fc1, 'b_fc1': b_fc1, 'W_fc2': W_fc2, 'b_fc2': b_fc2, 'global_step': global_step }
