...
# Net2Net_Cifar10_Teacher_deeper.py v0.9 01.05.2017
#
...
#
# Net2Net_Cifar10_Teacher_deeper.py contains the teacher CNN that we will use
# in the different experiments of the project with Net2DeeperNet 
...
CHKPT = './teacher-deeper' # File containing the teacher model
PATH_TENSORBOARD_LOG = './cifar-10-python/cifar-10-logs/teacher-deeper'
...
with tf.name_scope("ConvLayer1"):
    W_conv1 = N2NMoTb.init_weight([5, 5, 3, 32]) # 5x5 patch, 3 input channels, 64 output channels
...
with tf.name_scope("ConvLayer2"):
    W_conv2 = N2NMoTb.init_weight([5, 5, 32, 64]) # 5x5 patch, 64 input channels, 64 output channels
